...
HD_PWD='C:/Users/l3853/Documents/GitHub/FPGA/image_processing/image_process_parallel/image_process_parallel.runs/bram_image_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_image.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_image.tcl
