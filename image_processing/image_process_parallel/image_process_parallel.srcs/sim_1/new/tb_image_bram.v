...
module tb_top;
    ...
    // Monitor signals
    initial begin
        $monitor("Time: %0d, State: %b, Next State: %b, Ena: %b, Wea: %b, Addra: %d, Douta: %h, Done: %b, Done_in: %b, Red[0]: %h, Green[0]: %h, Blue[0]: %h, Red[1]: %h, Green[1]: %h, Blue[1]: %h, Red_o[0]: %h, Green_o[0]: %h, Blue_o[0]: %h, Red_o[1]: %h, Green_o[1]: %h, Blue_o[1]: %h, Done_out: %b",
                 $time, state, next_state, ena, wea, addra, douta, done, done_in, red_0, green_0, blue_0, red_1, green_1, blue_1, red_o_0, green_o_0, blue_o_0, red_o_1, green_o_1, blue_o_1, done_out);
    end
