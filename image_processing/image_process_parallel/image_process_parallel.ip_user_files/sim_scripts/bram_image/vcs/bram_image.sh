...
#
# Script generated by Vivado on Tue May 28 16:11:08 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_image.sh
...
#
# Usage        : bram_image.sh
#                bram_image.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_image.sh [-reset_run]
#                bram_image.sh [-reset_log]
#                bram_image.sh [-help]
#
...
#                script (type 'bram_image.sh -help' for more information).
#
...
# script info
echo -e "bram_image.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_image.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_image xil_defaultlib.glbl -o bram_image_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_image_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_image_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_image_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_image.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_image.sh [-help]\n\
Usage: bram_image.sh [-step]\n\
Usage: bram_image.sh [-lib_map_path]\n\
Usage: bram_image.sh [-reset_run]\n\
Usage: bram_image.sh [-reset_log]\n\
Usage: bram_image.sh [-keep_index]\n\
Usage: bram_image.sh [-noclean_files]\n\n\
